...
export function ChooseFrame({ onPick }: ChooseFrameProps) {
  return (
    <div>
      ...
      <Card as="button" className="nod-primary-path" style={{ padding: "26px 28px" }} onClick={() => onPick("own")}>
      ...
      <div className="nod-secondary-path">
        ...
        <button className="nod-sp-link" type="button" onClick={() => onPick("nod")}>
